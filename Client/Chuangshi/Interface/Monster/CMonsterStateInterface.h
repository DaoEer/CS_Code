...
public:
	...
	static FString GetClassPath() { return TEXT("BlueprintGeneratedClass'/Game/BluePrints/Entity/Interface/BP_CMonsterStateInterface.BP_CMonsterStateInterface_C'"); } //获取蓝图对象路径
