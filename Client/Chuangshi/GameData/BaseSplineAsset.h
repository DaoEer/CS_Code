...
class CHUANGSHI_API ABaseSplineAsset : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	///让粒子在路径上移动
	UFUNCTION(BlueprintCallable, Category = "SplinePath")
		void SceneComponentMoveOnSpline(USceneComponent* Target, bool bHaveOffset, float DeltaTime);
...
private:
	...
	///设置位置
	void SetTargetTransform(USceneComponent* Target, bool bHaveOffset);
