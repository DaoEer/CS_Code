...
class CHUANGSHI_API UBeginParticleModuleCollisionEX : public UParticleModuleBaseEX
{
...
class CHUANGSHI_API UEndParticleModuleCollisionEX : public UParticleModuleBaseEX
{
	GENERATED_UCLASS_BODY()
