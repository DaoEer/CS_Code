...
DECLARE_STATS_GROUP(TEXT("AFlyEffectEmitter"), STATGROUP_AFlyEffectEmitter, STATCAT_Advanced);
 ...
 */
UCLASS(abstract)
class CHUANGSHI_API AFlyEffectEmitter : public AEffectEmitter
{
	GENERATED_BODY()
...
protected:
	...
	void SetEffectLocationAndRotation(const float& MoveDistance, const FVector& RisingOffset, const FVector& TargetLocation);
	///正常移动
