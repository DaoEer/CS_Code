#include "EffectClientNormalDamage1.h"
...
UEffectClientNormalDamage1::UEffectClientNormalDamage1()
{
}
...
void UEffectClientNormalDamage1::init(FHIT_EFFECT dictDat, USkill * skill)
{
...
bool UEffectClientNormalDamage1::canEffect(USkill * skill, CS3Entity * caster, CS3Entity * receiver)
{
...
void UEffectClientNormalDamage1::onReceive(USkill * skill, CS3Entity * caster, CS3Entity * receiver)
{
	...
	//float Romdan = 2.0 * FMath::FRandRange(0.0f, 0.99f) - 1.0;
	float Random = FMath::FRandRange(-1.0f, 1.0f);
	int32 recDamage = FMath::CeilToInt((damage * _skillRadio + _skillValue) *(1.0 + CasterBaseCom.DamRandom * Random));
...
int32 UEffectClientNormalDamage1::CustomAttrC(FString propertyStr, int32 propertyValue)
{
...
int32 UEffectClientNormalDamage1::CustomAttrR(FString propertyStr, int32 propertyValue)
{
