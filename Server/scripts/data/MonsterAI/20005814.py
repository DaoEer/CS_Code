                        ...
                        "Actions": [
                            {
                                ...
                                "param3": "", 
                                "param2": "", 
                                "param1": "t1|t2|t10|t11|t20|t21|t30|JL1"
                            }, 
                            {
                                "script": "AIAction56", 
                                "param5": "", 
                            ...
                            }, 
                            {
                                ...
                                "param3": "", 
                                "param2": "", 
                                "param1": "pt1|cr1|cr2|cr21|cr11|th3|th2|th1|yb1|JL1|th2"
                            }, 
                            {
                                "script": "AIAction56", 
                                "param5": "", 
        ...
        "subStateDatas": {
            ...
            4: {
                ...
                "statesAI": [
                    ...
                    {
                        "comment": "cr1=2时，点名，播放提示，发送totem1", 
                        "odds": 1.0, 
                        "Actions": [
                            {
                                "script": "AIAction4", 
                ...
                "statesAI": [
                    ...
                    }, 
                    {
                        ...
                        "Actions": [
                            ...
                            {
                                "script": "AIAction169", 
                                "param5": "17|70|20005812", 
                                "param4": "37|7", 
                                "param3": "", 
                                "param2": "", 
                                "param1": "-3290 3400 850"
                            }
                        ], 
                        "EID": [
                            58
            ...
            6: {
                ...
                "eventsAI": {
                    ...
                    6: [
                        ...
                        {
                            "comment": "血量低于47，插人失败，存在JL1 进入13", 
                            "odds": 1.0, 
                            "Actions": [
                                {
                                    "script": "AIAction59", 
            ...
            13: {
                ...
                "eventsAI": {
                    9: [
                        {
                            "comment": "高于40，进入9。收到阴兵死亡指令，重新出场", 
                            "odds": 1.0, 
                            "Actions": [
                                {
                                    "script": "AIAction21", 
                        ...
                        {
                            "comment": "低于40，进入10。收到阴兵死亡指令，重新出场", 
                            "odds": 0.0, 
                            "Actions": [
                                {
                                    "script": "AIAction21", 
            ...
            14: {
                ...
                "statesAI": [
                    {
                        "comment": "记录时间by1,JL1,同时增加进入此状态行为152 154 203的EAI", 
                        "odds": 1.0, 
                        "Actions": [
                            {
                                "script": "AIAction17", 
