    ...
    "fight": {
        "subStateDatas": {
            1: {
                ...
                "statesAI": [
                    {
                        "comment": "指挥士兵攻击 开启战斗模式 记录t21时间标签", 
                        "odds": 1.0, 
                        "Actions": [
                            {
                                "script": "AIAction268", 
        ...
        "subStateDatas": {
            1: {
                ...
                "statesAI": [
                    ...
                    {
                        "comment": "没有标签，不再进行判断，并且给陷阱发送查询指令", 
                        "odds": 1.0, 
                        "Actions": [
                            {
                                "script": "AIAction25", 
            ...
            2: {
                ...
                "statesAI": [
                    ...
                    {
                        "comment": "到达位置之后，5秒内没有敌人出现，切换3回自己地盘", 
                        "odds": 1.0, 
                        "Actions": [
                            {
                                "script": "AIAction56", 
