...
import CoreInterface.CMonsterCombatInterface as CMonsterCombatInterface
...
class CMonsterObject(
	...
	CMonsterCombatInterface.CMonsterCombatInterface,
	...
	def __init__( self ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.__init__( self )
	...
	def onHPChanged( self, oldValue ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.onHPChanged( self, oldValue )
	...
	def updateRelation( self ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.updateRelation(self)
	...
	def beforeDestroy( self ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.beforeDestroy( self )
	...
	def onMoveOver( self, controllerID, userData ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.doMoveOver( self, controllerID, userData )
	...
	def onMoveFailure( self, controllerID, userData ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.doMoveFailure( self, controllerID, userData )
...
#---------------------- timer --------------------------
	def timerValeDelCB( self, timerArg ):
		...
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.timerValeDelCB( self, timerArg )
	...
	def changeState( self, newState ):
		...
		if self.state == newState:
			return
		CMonsterCombatInterface.CMonsterCombatInterface.changeState(self,newState)
	...
	def onStateChanged( self, new, old ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.onStateChanged(self, new, old)
		self.updateRelation()

	def onActWordChangedTrigger(self, params):
		"""
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onActWordChangedTrigger(self, params)
		act, disabled =  params
	...
	def onEnterFree( self ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterFree(self)
	...
	def onLeaveFree( self ):
		...
		离开自由状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveFree(self)
	...
	def onEnterFight( self ):
		...
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterFight(self)
	...
	def onLeaveFight( self ):
		...
		离开战斗
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveFight(self)
		self.allClients.CLIENT_RemoveChasePosInfo()
		self.getScript().onLeaveFight( self )
	
	def onEnterDead( self ):
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterDead( self )
	...
	def onLeaveDead( self ):
		...
		离开死亡状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveDead(self)
	...
	def onEnterPead( self ):
		...
		进入未决状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterPead(self)
	...
	def onLeavePead( self ):
		...
		离开未决状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeavePead(self)
	...
	def onEnterWarn( self ):
		...
		进入警戒状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterWarn(self)
	...
	def onLeaveWarn( self ):
		...
		离开警戒状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveWarn(self)
	...
	def onEnterReset( self ):
		...
		进入重置状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterReset(self)
	...
	def onLeaveReset( self ):
		...
		离开重置状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveReset(self)
	...
	def onEnterShow( self ):
		...
		进入表演状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterShow(self)
	...
	def onLeaveShow( self ):
		...
		离开表演状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveShow(self)
	...
	def onEnterStable( self ):
		...
		进入稳定状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onEnterStable(self)
	...
	def onLeaveStable( self ):
		...
		离开稳定状态
		"""
		CMonsterCombatInterface.CMonsterCombatInterface.onLeaveStable(self)
