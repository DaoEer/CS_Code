...
class HoldEffectUncontrollable( HoldEffect ):
	"""
	持有效果：霸体
	"""
	def __init__( self ):
	...
	def onBegin( self, effectData, receiver ):
		...
		receiver.effectStateInc( csdefine.EFFECT_STATE_UNCONTROLLABLE )

	def onEnd( self, effectData, receiver ):
		"""
		效果结束
		"""
		receiver.effectStateDec( csdefine.EFFECT_STATE_UNCONTROLLABLE )
