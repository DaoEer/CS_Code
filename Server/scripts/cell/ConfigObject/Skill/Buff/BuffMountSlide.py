...
class BuffMountSlide ( BuffHold ):
	...
	def init( self, dictDat ):
		...
		if dictDat["Param3"]:
			self.accelerateSpeed = float(dictDat["Param3"]) * 100
	...
	def doBegin( self, receiver, buffData ):
		...
		receiver.allClients.CLIENT_OnMountSlide( self.delayTime, self.initSpeed * 100 / self.maxSpeed, self.accelerateSpeed, self.modelID, self.InputYawScale, 0 )
	...
	def doEnd( self, receiver, buffData,reason ):
		...
		receiver.allClients.CLIENT_OnDismountSlide()
	...
	def onClientActorCreate( self, receiver, buffData, srcEntityID ):
		...
		clientEntity.CLIENT_OnMountSlide( 0.0, 0.0, 0.0, self.modelID, self.InputYawScale, 0 )