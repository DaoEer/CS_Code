...
STATE_TO_ACTION_FLAGS = {
			csdefine.ENTITY_STATE_PEAD				: [csdefine.ACTION_FORBID_USE_ITEM, csdefine.ACTION_FORBID_WIELD, csdefine.ACTION_FORBID_ATTACK, 
													   csdefine.ACTION_FORBID_SPELL, csdefine.ACTION_FORBID_TALK , csdefine.ACTION_FORBID_BE_ATTACK , csdefine.ACTION_FORBID_TRIGGER_PASSIVE, csdefine.ACTION_FORBID_BE_HIT_BACK , csdefine.ACTION_FORBID_MOVE , csdefine.ACTION_FORBID_JUMP, csdefine.ACTION_FORBID_EMERGENCY_EXIT,
													   csdefine.ACTION_FORBID_BE_CONTROL],
			csdefine.ENTITY_STATE_FREE				: [],
			csdefine.ENTITY_STATE_WARN				: [],
			csdefine.ENTITY_STATE_FIGHT				: [],
			csdefine.ENTITY_STATE_SHOW				: [csdefine.ACTION_FORBID_BE_HIT_BACK, csdefine.ACTION_FORBID_BE_ATTACK, 
													   csdefine.ACTION_FORBID_BE_CONTROL],
			csdefine.ENTITY_STATE_DEAD				: [csdefine.ACTION_FORBID_MOVE, csdefine.ACTION_FORBID_WIELD, csdefine.ACTION_FORBID_ATTACK,
													   csdefine.ACTION_FORBID_SPELL, csdefine.ACTION_FORBID_JUMP, csdefine.ACTION_FORBID_TALK, csdefine.ACTION_FORBID_CONJURE_PET , csdefine.ACTION_FORBID_TRANSLATE_DIRECTION , csdefine.ACTION_FORBID_EMERGENCY_EXIT, csdefine.ACTION_FORBID_BE_ATTACK, csdefine.ACTION_FORBID_BE_CONTROL,
													   csdefine.ACTION_FORBID_TRIGGER_PASSIVE, csdefine.ACTION_FORBID_BE_DEPRESS, csdefine.ACTION_FORBID_INSANE],
			csdefine.ENTITY_STATE_RESET				: [csdefine.ACTION_FORBID_ATTACK, csdefine.ACTION_FORBID_SPELL, csdefine.ACTION_FORBID_BE_ATTACK, csdefine.ACTION_FORBID_BE_HIT_BACK, 
													   csdefine.ACTION_FORBID_BE_CONTROL, csdefine.ACTION_FORBID_BE_DEPRESS, csdefine.ACTION_FORBID_INSANE],
	}


class VehiclePetStateInterface(StateInterface):
	def __init__(self):
