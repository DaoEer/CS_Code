...
class SpaceContainerTeam( SpaceContainerBase.SpaceContainerBase ):
	...
	def packDataToLogin( SELF, spaceScriptID, roleEntity, args ):
		...
		打包数据，用于登陆
		"""
		packDict = { "playerDBID": roleEntity.cellData["playerDBID"], "teamID": roleEntity.teamID, "spaceKey": str( roleEntity.teamID ), "belongType": csdefine.SPACE_BELONG_TEAM ,"profession": roleEntity.cellData["profession"], "camp": roleEntity.cellData["camp"]}
		args.update( packDict )
		return args
