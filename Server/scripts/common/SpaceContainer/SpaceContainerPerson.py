...
class SpaceContainerPerson( SpaceContainerBase.SpaceContainerBase ):
	...
	def packDataToLogin( SELF, spaceScriptID, roleEntity, args ):
		...
		打包数据，用于登陆
		"""
		packDict = { "playerDBID": roleEntity.cellData["playerDBID"], "spaceKey": str( roleEntity.cellData["playerDBID"] ), "belongType": csdefine.SPACE_BELONG_PERSON,"profession": roleEntity.cellData["profession"], "camp": roleEntity.cellData["camp"] }
		args.update( packDict )
		return args
