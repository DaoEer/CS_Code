...
class SpaceContainerNomal( SpaceContainerBase.SpaceContainerBase ):
	...
	def packDataToLogin( SELF, spaceScriptID, roleEntity, args ):
		...
		打包数据，用于登陆
		"""
		packDict = { "spaceKey": spaceScriptID, "belongType": csdefine.SPACE_BELONG_NORMAL,"playerDBID": roleEntity.cellData["playerDBID"],"profession": roleEntity.cellData["profession"], "camp": roleEntity.cellData["camp"] }
		args.update( packDict )
		return args
