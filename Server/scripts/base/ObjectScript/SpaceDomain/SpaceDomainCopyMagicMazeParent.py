...
class SpaceDomainCopyMagicMazeParent( DomainBase, SpaceTeamRelationInterface ):
	"""
	副本空间领域
	"""
	def __init__( self ):
	...
	def onSpaceCreateCallBack( self, spaceItem, spaceBase ):
		...
		space base创建完成
		"""
		KBEngine.globalData["MagicMazeSpaceManager"].onMainSpaceCreate( spaceItem.belongType, spaceItem.spaceKey, spaceBase, self.scriptID )
